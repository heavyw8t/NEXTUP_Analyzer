# Invalidation Library — Generic Reasons for Web3 Security Finding Rejection/Downgrade

> **Usage**: The Phase 5 Pre-Screen Selector Agent reads this file and picks the 2-3 most applicable reasons for each finding. Each reason is self-contained — the agent matches based on the finding's characteristics.
> **Origin**: Adapted from the Judge skill's invalidation library for pipeline-internal use.
