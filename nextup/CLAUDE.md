...
| Precedent scout (4b.4) | Skip | 1 haiku per injectable finding | 1 haiku per injectable finding |
...
| Report | 2 agents (sonnet + sonnet) | 5 agents (opus + sonnet) | 5 agents (opus + sonnet) |
